...
- **MUST** include Google docstrings for all public functions, classes, and methods
...
- **MUST** write unit tests for all new functions and classes if requested in the PR
